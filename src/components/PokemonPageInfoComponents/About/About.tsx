...
const About = ({
  ...
  thisPokemon: Pokemon;
  thisPokemonDetails: IPokemonSpecies;
}) => {
  const flavorTextToDisplay = (thisPokemonDetails: IPokemonSpecies) => {
    if (thisPokemonDetails?.flavor_text_entries[1]?.language.name === "en") {
      return thisPokemonDetails?.flavor_text_entries[1]?.flavor_text;
    } else if (thisPokemonDetails?.flavor_text_entries[2]?.language.name === "en") {
      return thisPokemonDetails?.flavor_text_entries[2]?.flavor_text;
    } else if (thisPokemonDetails?.flavor_text_entries[0]?.language.name === "en") {
      return thisPokemonDetails?.flavor_text_entries[0]?.flavor_text;
    } else if (thisPokemonDetails?.flavor_text_entries[7]?.language.name === "en") {
      return thisPokemonDetails?.flavor_text_entries[7]?.flavor_text;
    } else if (thisPokemonDetails?.flavor_text_entries[17]?.language.name === "en") {
